    ...
    return Container(
      ...
      child: Padding(
        ...
        child: ListView.builder(
          ...
          itemCount: searching.recomended.length,
            ...
            return Padding(
              ...
              child: GestureDetector(
                onTap: () => Navigator.pushNamed(
                  context,
                  '/detailProduct',
                  arguments: searching.recomended[index],
                ),
                child: Container(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                          image: NetworkImage(
                            searching.recomended[index].getImgUrl(),
                          ),
                          fit: BoxFit.fitWidth,
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            searching.recomended[index].productName,
                            maxLines: 3,
                            style: TextStyle(
                                color: Colors.grey,
                                fontSize: 11,
                          ...
                          Text(
                            searching.recomended[index].refProdCode,
                            maxLines: 1,
